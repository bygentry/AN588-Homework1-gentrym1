...
```{r}
# I recommend writing your code in code blocks so you can easily re-run and edit it as your work. You can either use the Insert drop down menu at the top of your editor pane or use the shortcut "ctrl + alt + i" (cmnd + alt + i on mac)
...
# You don't technically need both of these objects, but it isn't a detriment to have both. I will say that in general it's better to have a clear naming convention, like ulysses_remove1 and ulysses_remove2 so you don't accidentally use the wrong object down the line.
...
# Very clean, I didn't know you could index with a list like this. Going back to my first note, another benefit of using code blocks is that you don't need to copy the output because it can easily be reproduced. 
...
# Looking beyond the output, can you describe how do these commands interact with the matrix to produce the results?
```
